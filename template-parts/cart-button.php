...
?>
<div class="creditkey" style="margin-bottom: 15px; display: flex; justify-content: flex-end;">
	<a href="#" id="ck-cart-link" class="ck-link" style="color: #3a3a3a;font-family: 'Open Sans', sans-serif;font-weight:400;font-size: 15px; text-align: right; line-height: 20px;">
